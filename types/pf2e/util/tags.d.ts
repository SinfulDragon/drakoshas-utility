...
import { HTMLTagifyTagsElement } from "@system/html-elements/tagify-tags.js";
import Tagify, { TagifySettings } from "@yaireo/tagify";
declare function traitSlugToObject(trait: string, dictionary: Record<string, string | undefined>, options?: {
