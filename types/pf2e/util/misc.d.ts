...
import type { ActionCost } from "@item/base/data/system.js";
...
declare function localizeList(items: string[], { conjunction, sort }?: {
    conjunction?: "and" | "or";
    sort?: boolean;
}): string;
/**
