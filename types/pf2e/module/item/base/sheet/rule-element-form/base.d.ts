...
import { type RuleElement, type RuleElementSource } from "@module/rules/index.js";
import { RuleElementSchema } from "@module/rules/rule-element/data.js";
import type { LaxSchemaField } from "@system/schema-data-fields.js";
import type { ItemSheetPF2e } from "../index.js";
...
interface RuleElementFormSheetData<TSource extends RuleElementSource, TObject extends RuleElement | null> extends Omit<RuleElementFormOptions<TSource, TObject>, "sheet"> {
    item: ItemPF2e;
    label: string;
