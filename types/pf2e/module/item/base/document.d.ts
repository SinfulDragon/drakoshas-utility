...
import type { DatabaseCreateCallbackOptions, DatabaseCreateOperation, DatabaseDeleteCallbackOptions, DatabaseDeleteOperation, DatabaseUpdateCallbackOptions, Document } from "@common/abstract/_module.d.mts";
import type { ImageFilePath, RollMode } from "@common/constants.d.mts";
import type { PhysicalItemPF2e } from "@item";
import type { ItemOriginFlag } from "@module/chat-message/data.js";
import { ChatMessagePF2e } from "@module/chat-message/document.js";
import { RuleElement, RuleElementOptions } from "@module/rules/index.js";
import { type EnrichmentOptionsPF2e, type RollDataPF2e } from "@system/text-editor.js";
import type { ItemInstances, ItemType } from "../types.js";
import type { ItemFlagsPF2e, ItemSourcePF2e, ItemSystemData, RawItemChatData, TraitChatData } from "./data/index.js";
import type { ItemDescriptionData, ItemTrait } from "./data/system.js";
import type { ItemSheetPF2e } from "./sheet/sheet.js";
...
declare class ItemPF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends Item<TParent> {
    ...
    getRollOptions(prefix?: any, { includeGranter }?: {
