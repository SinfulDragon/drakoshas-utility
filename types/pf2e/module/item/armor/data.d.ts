...
import type { TraitConfig } from "@item/base/data/system.js";
import { BasePhysicalItemSource, Investable, ItemMaterialSource, PhysicalItemTraits, PhysicalSystemData, PhysicalSystemSource } from "@item/physical/data.js";
import type { Grade } from "@item/physical/types.js";
import { WornUsage } from "@item/physical/usage.js";
import { ZeroToFour } from "@module/data.js";
import { ArmorCategory, ArmorGroup, ArmorPropertyRuneType, ArmorTrait, BaseArmorType, OtherArmorTag } from "./index.js";
