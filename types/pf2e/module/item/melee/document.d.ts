...
import type { BaseWeaponType, WeaponCategory, WeaponGroup } from "@item/weapon/types.js";
import type { ChatMessagePF2e } from "@module/chat-message/document.js";
import { ConvertedNPCDamage } from "@system/damage/weapon.js";
import type { MeleeFlags, MeleeSource, MeleeSystemData } from "./data.js";
import type { NPCAttackTrait } from "./types.js";
declare class MeleePF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends ItemPF2e<TParent> {
    ...
    protected _preUpdate(changed: DeepPartial<this["_source"]>, options: foundry.abstract.DatabaseUpdateCallbackOptions, user: fd.BaseUser): Promise<boolean | void>;
}
