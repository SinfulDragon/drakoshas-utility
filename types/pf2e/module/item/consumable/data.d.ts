import type { BasePhysicalItemSource, PhysicalItemTraits, PhysicalSystemData, PhysicalSystemSource } from "@item/physical/data.js";
import type { SpellSource } from "@item/spell/data.js";
import type { DamageKind, DamageType } from "@system/damage/index.js";
import type { ConsumableCategory, ConsumableTrait, OtherConsumableTag } from "./types.js";
