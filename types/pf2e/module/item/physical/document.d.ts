...
import type { DatabaseCreateCallbackOptions, DatabaseDeleteOperation, DatabaseUpdateCallbackOptions, DatabaseUpdateOperation } from "@common/abstract/_types.d.mts";
import { ItemPF2e, type ContainerPF2e } from "@item";
import type { ItemSourcePF2e, PhysicalItemSource, RawItemChatData, TraitChatData } from "@item/base/data/index.js";
import type { Rarity, Size, ZeroToTwo } from "@module/data.js";
import { RuleElement, RuleElementOptions } from "@module/rules/index.js";
import type { EffectSpinoff } from "@module/rules/rule-element/effect-spinoff/spinoff.js";
import { Bulk } from "./bulk.js";
import type { IdentificationStatus, ItemCarryType, ItemMaterialData, MystifiedData, PhysicalItemHitPoints, PhysicalItemTrait, PhysicalSystemData, Price } from "./data.js";
import { Coins } from "./helpers.js";
declare abstract class PhysicalItemPF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends ItemPF2e<TParent> {
    ...
    attach(item: PhysicalItemPF2e, { quantity, stack, render }?: {
        quantity?: number;
        stack?: boolean;
        render?: boolean;
    }): Promise<boolean>;
     ...
     */
    detach({ skipConfirm, quantity, keepZero, }?: {
        skipConfirm?: boolean;
        quantity?: number;
        keepZero?: boolean;
    }): Promise<void>;
