import type { Language, SenseAcuity, SenseType } from "@actor/creature/types.js";
...
import { FrequencyField, SelfEffectReference } from "@item/ability/index.js";
import { AbilityTraitToggles } from "@item/ability/trait-toggles.js";
import type { ArmorCategory } from "@item/armor/types.js";
import { ItemSystemModel, ItemSystemSchema } from "@item/base/data/model.js";
import type { ActionType, BaseItemSourcePF2e, Frequency, ItemSystemSource, ItemTraits } from "@item/base/data/system.js";
import type { ClassTrait } from "@item/class/types.js";
import type { WeaponCategory } from "@item/weapon/types.js";
import type { OneToFour, OneToThree } from "@module/data.js";
import { RarityField } from "@module/model.js";
import { RecordField, SlugField } from "@system/schema-data-fields.js";
import type { FeatPF2e } from "./document.js";
import type { FeatOrFeatureCategory, FeatTrait } from "./types.js";
