...
import type { ActionType, BaseItemSourcePF2e, Frequency, FrequencyInterval, FrequencySource, ItemSystemSource } from "@item/base/data/system.js";
import type { OneToThree } from "@module/data.js";
import { SlugField } from "@system/schema-data-fields.js";
import type { AbilityItemPF2e } from "./document.js";
import { AbilityTraitToggles } from "./trait-toggles.js";
import type { AbilityTrait, ActionCategory } from "./types.js";
...
interface AbilitySystemData extends ItemSystemModel<AbilityItemPF2e, AbilitySystemSchema>, Omit<fields.ModelPropsFromSchema<AbilitySystemSchema>, "description"> {
}
