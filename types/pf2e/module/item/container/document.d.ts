...
import type { EquipmentTrait } from "@item/equipment/data.js";
import { Bulk } from "@item/physical/bulk.js";
import { PhysicalItemPF2e } from "@item/physical/document.js";
import type { ContainerSource, ContainerSystemData } from "./data.js";
declare class ContainerPF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends PhysicalItemPF2e<TParent> {
    ...
    contents: Collection<string, PhysicalItemPF2e<NonNullable<TParent>>>;
