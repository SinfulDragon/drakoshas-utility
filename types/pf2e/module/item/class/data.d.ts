import type { AttributeString, SkillSlug } from "@actor/types.js";
import type { ModelPropsFromSchema, SourceFromSchema } from "@common/data/fields.d.mts";
import { ABCFeatureEntryField } from "@item/abc/data.js";
import { ItemSystemModel, ItemSystemSchema } from "@item/base/data/model.js";
import type { BaseItemSourcePF2e, ItemSystemSource, RarityTraitAndOtherTags } from "@item/base/data/system.js";
import { ProficiencyRankField, RarityField } from "@module/model.js";
import { LaxArrayField, RecordField, SlugField } from "@system/schema-data-fields.js";
import type { ClassPF2e } from "./document.js";
