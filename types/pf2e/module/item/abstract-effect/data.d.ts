...
import type { ItemSystemSchema } from "@item/base/data/model.js";
import type { ItemDescriptionData } from "@item/base/data/system.js";
import type { MagicTradition } from "@item/spell/index.js";
import type { CheckRoll } from "@system/check/index.js";
import type { DegreeOfSuccessIndex } from "@system/degree-of-success.js";
import { SlugField } from "@system/schema-data-fields.js";
import type { BadgeReevaluationEventType, EffectExpiryType, EffectTrait, TimeUnit } from "./types.js";
