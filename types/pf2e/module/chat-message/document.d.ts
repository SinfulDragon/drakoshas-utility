...
import type { AttackAction, StrikeData } from "@actor/data/base.js";
import type { DataModelConstructionContext } from "@common/abstract/_module.d.mts";
import type { ChatMessageCreateCallbackOptions, ChatMessageCreateOperation } from "@common/documents/chat-message.d.mts";
import { ItemPF2e } from "@item";
import type { UserPF2e } from "@module/user/index.js";
import type { ScenePF2e, TokenDocumentPF2e } from "@scene/index.js";
...
declare class ChatMessagePF2e extends ChatMessage {
    ...
    protected _onCreate(data: this["_source"], options: ChatMessageCreateCallbackOptions & {
...
declare namespace ChatMessagePF2e {
    function createDocuments<TDocument extends foundry.abstract.Document>(this: ConstructorOf<TDocument>, data?: (TDocument | DeepPartial<TDocument["_source"]>)[], operation?: Partial<MessageCreateOperationPF2e>): Promise<TDocument[]>;
