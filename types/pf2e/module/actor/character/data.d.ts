import type { CraftingAbilityData, CraftingFormulaData } from "@actor/character/crafting/index.js";
import { AbilityData, BaseCreatureSource, CreatureAttributes, CreatureDetails, CreatureDetailsSource, CreatureLanguagesData, CreaturePerceptionData, CreatureResources, CreatureSystemData, CreatureSystemSource, HeldShieldData, SaveData, SkillData } from "@actor/creature/data.js";
import { CreatureInitiativeSource, Language } from "@actor/creature/index.js";
import { ActorAttributesSource, ActorFlagsPF2e, AreaAttack, AttributeBasedTraceData, HitPointsStatistic, InitiativeData, StrikeData, TraitViewData } from "@actor/data/base.js";
import { AttributeString, SaveType, SkillSlug } from "@actor/types.js";
import type { WeaponPF2e } from "@item";
import { ArmorCategory } from "@item/armor/types.js";
import { ProficiencyRank } from "@item/base/data/index.js";
import { DeitySystemData } from "@item/deity/data.js";
import { DeityDomain } from "@item/deity/types.js";
import { BaseWeaponType, WeaponCategory, WeaponGroup } from "@item/weapon/types.js";
...
import type { WeaponAuxiliaryAction } from "./auxiliary.js";
...
export type { AttributeBoosts, BaseWeaponProficiencyKey, CategoryProficiencies, CharacterAbilities, CharacterAreaAttack, CharacterAttack, CharacterAttributes, CharacterAttributesSource, CharacterBiography, CharacterDetails, CharacterDetailsSource, CharacterFlags, CharacterHandsData, CharacterProficiency, CharacterResources, CharacterResourcesSource, CharacterSaveData, CharacterSaves, CharacterSkillData, CharacterSource, CharacterStrike, CharacterSystemData, CharacterSystemSource, ClassDCData, MartialProficiency, WeaponGroupProficiencyKey, };
