import type { ActorAttributes, ActorAttributesSource, ActorDetailsSource, ActorHitPoints, ActorHitPointsSource, ActorSystemData, ActorSystemSource, ActorTraitsSource, AttributeBasedTraceData, BaseActorSourcePF2e } from "@actor/data/base.js";
import type { ActorSizePF2e } from "@actor/data/size.js";
import type { Modifier, RawModifier } from "@actor/modifiers.js";
import type { AttributeString, MovementType, SaveType, SkillSlug } from "@actor/types.js";
import type { ImageFilePath } from "@common/constants.d.mts";
import type { LabeledNumber, Size, ValueAndMax, ValueAndMaybeMax, ZeroToThree } from "@module/data.js";
import type { ArmorClassTraceData } from "@system/statistic/index.js";
import type { PerceptionTraceData } from "@system/statistic/perception.js";
import { LandSpeedStatisticTraceData, SpeedStatisticTraceData } from "@system/statistic/speed.js";
import type { CreatureActorType, CreatureTrait, Language, SenseAcuity, SenseType, SpecialVisionType } from "./types.js";
