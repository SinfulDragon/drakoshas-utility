import type { ActorAttributes, ActorDetails, ActorHitPoints, BaseActorSourcePF2e } from "@actor/data/base.js";
import type { Resistance, Weakness } from "@actor/data/iwr.js";
import { Immunity } from "@actor/data/iwr.js";
import { ActorHitPointsSchema, ActorSystemModel, ActorSystemSchema } from "@actor/data/model.js";
import { ActorSizePF2e } from "@actor/data/size.js";
import type { ActorAlliance, ImmunityType, ResistanceType, WeaknessType } from "@actor/types.js";
import type { Rarity, Size } from "@module/data.js";
import { PublicationField } from "@module/model.js";
import { DataUnionField } from "@system/schema-data-fields.js";
import type { ArmorClassTraceData } from "@system/statistic/armor-class.js";
import type { VehiclePF2e } from "./document.js";
import type { VehicleTrait } from "./types.js";
