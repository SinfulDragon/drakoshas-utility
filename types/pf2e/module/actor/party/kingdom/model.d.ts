...
import { PartySystemData } from "../data.js";
import { PartyCampaign } from "../types.js";
import { KingdomCHG, KingdomCharter, KingdomData, KingdomGovernment, KingdomSchema, KingdomSource } from "./schema.js";
import type { KingdomNationType, KingdomSkill } from "./types.js";
/** Model for the Kingmaker campaign data type, which represents a Kingdom */
declare class Kingdom extends foundry.abstract.DataModel<PartySystemData, KingdomSchema> implements PartyCampaign {
