import type { RawModifier } from "@actor/modifiers.js";
...
import { DataUnionField, RecordField, StrictBooleanField, StrictStringField } from "@system/schema-data-fields.js";
import type { FameType, KingdomAbility, KingdomBoostCategory, KingdomCommodity, KingdomLeadershipRole, KingdomSettlementType, KingdomSkill } from "./types.js";
...
type NullableSchemaField<TSchema extends DataSchema> = fields.SchemaField<TSchema, fields.SourceFromSchema<TSchema>, fields.ModelPropsFromSchema<TSchema>, true, true, true>;
type BuildSchema = {
...
export type { KingdomAbilityData, KingdomBuildData, KingdomCharter, KingdomCHG, KingdomData, KingdomGovernment, KingdomHeartland, KingdomLeadershipData, KingdomSchema, KingdomSettlementData, KingdomSource, };
