...
import { DamageAlteration } from "@module/rules/rule-element/damage-alteration/alteration.js";
import type { DamageCategoryUnique, DamageDiceFaces, DamageDieSize, DamageType } from "@system/damage/types.js";
import { Predicate, RawPredicate } from "@system/predication.js";
...
declare const MODIFIER_TYPES: Set<"untyped" | "circumstance" | "ability" | "item" | "potency" | "proficiency" | "status">;
...
declare class Modifier implements RawModifier {
    ...
    applyAdjustments({ rollOptions }: {
        rollOptions: Iterable<string>;
    }): void;
    /**
...
declare class CheckModifier extends StatisticModifier {
    ...
    }, modifiers?: Modifier[], rollOptions?: string[] | Set<string>);
}
...
export { adjustModifiers, applyStackingRules, CheckModifier, createAttributeModifier, createProficiencyModifier, DamageDicePF2e, ensureProficiencyOption, Modifier, MODIFIER_TYPES, PROFICIENCY_RANK_OPTION, StatisticModifier, };
