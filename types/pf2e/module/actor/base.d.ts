...
import type { DatabaseCreateOperation, DatabaseDeleteCallbackOptions, DatabaseUpdateOperation, Document } from "@common/abstract/_module.d.mts";
...
import type { ItemSourcePF2e, PhysicalItemSource } from "@item/base/data/index.js";
import type { ConditionKey, ConditionSlug, ConditionSource } from "@item/condition/index.js";
...
import type { AppliedDamageFlag } from "@module/chat-message/index.js";
import type { Size } from "@module/data.js";
import { CombatantPF2e, EncounterPF2e } from "@module/encounter/index.js";
import type { RuleElementSynthetics } from "@module/rules/index.js";
import type { RuleElement } from "@module/rules/rule-element/base.js";
import type { UserPF2e } from "@module/user/document.js";
import type { ScenePF2e } from "@scene/document.js";
import { TokenDocumentPF2e } from "@scene/token-document/document.js";
import type { DamageType } from "@system/damage/types.js";
import type { ArmorStatistic, PerceptionStatistic, Statistic, StatisticDifficultyClass } from "@system/statistic/index.js";
import { type RollDataPF2e } from "@system/text-editor.js";
import { ActorConditions } from "./conditions.js";
import { Abilities, VisionLevel } from "./creature/data.js";
import type { GetReachParameters, ModeOfBeing, ResourceData } from "./creature/types.js";
import { ActorFlagsPF2e, ActorSystemData, PrototypeTokenPF2e, RollOptionFlags } from "./data/base.js";
import type { ActorSourcePF2e } from "./data/index.js";
import type { ActorInitiative } from "./initiative.js";
import { ActorInventory } from "./inventory/index.js";
import type { ActorSheetPF2e } from "./sheet/base.js";
import type { ActorSpellcasting } from "./spellcasting.js";
import type { ActorRechargeData, ActorType, EmbeddedItemInstances } from "./types.js";
/**
