...
import type { InitiativeTraceData } from "@actor/initiative.js";
import type { Modifier, StatisticModifier } from "@actor/modifiers.js";
import type { ActorAlliance, AttributeString, SkillSlug } from "@actor/types.js";
...
import type { MigrationRecord, Rarity, Size, ValueAndMaybeMax, ZeroToTwo } from "@module/data.js";
import type { AutoChangeEntry } from "@module/rules/rule-element/ae-like.js";
import type { AttackRollParams, DamageRollParams, RollParameters } from "@module/system/rolls.js";
import type { CheckRoll } from "@system/check/roll.js";
...
import type { Immunity, ImmunitySource, Resistance, ResistanceSource, Weakness, WeaknessSource } from "./iwr.js";
import type { ActorSizePF2e } from "./size.js";
...
export type { ActorAttributes, ActorAttributesSource, ActorDetails, ActorDetailsSource, ActorFlagsPF2e, ActorHitPoints, ActorHitPointsSource, ActorSystemData, ActorSystemSource, ActorTraitsData, ActorTraitsSource, AreaAttack, ArmorClassData, AttackAction, AttackAmmunitionData, AttributeBasedTraceData, BaseActorSourcePF2e, BaseHitPointsSource, BasicAttackAction, DamageRollFunction, FlankingData, GangUpCircumstance, HitPointsStatistic, InitiativeData, PrototypeTokenPF2e, Rollable, RollFunction, RollOptionFlags, StrikeData, TraitViewData, };
