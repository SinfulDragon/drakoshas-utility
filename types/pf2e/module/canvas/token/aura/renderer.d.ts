import { AuraAppearanceData, AuraData } from "@actor/types.js";
import type { GridHighlight } from "@client/canvas/containers/_module.d.mts";
import { ItemTrait } from "@item/base/data/system.js";
import { TokenAuraData } from "@scene/token-document/aura/index.js";
import type { EffectAreaSquare } from "../../effect-area-square.js";
