import { PredicateField, SlugField } from "@system/schema-data-fields.js";
...
declare class ResolvableValueField<TRequired extends boolean, TNullable extends boolean, THasInitial extends boolean = false> extends fields.DataField<RuleValue, RuleValue, TRequired, TNullable, THasInitial> {
    #private;
