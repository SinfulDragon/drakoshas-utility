...
import type { CheckModifier, DamageDicePF2e, Modifier } from "@actor/modifiers.js";
import type { Rolled } from "@client/dice/roll.d.mts";
import type { DatabaseCreateOperation, DatabaseDeleteOperation, DataModelConstructionContext, DataModelValidationOptions } from "@common/abstract/_types.d.mts";
...
import { CheckCheckContext, CheckRoll } from "@system/check/index.js";
import { LaxSchemaField } from "@system/schema-data-fields.js";
import { RuleElementSchema, RuleElementSource, RuleValue } from "./data.js";
/**
...
declare abstract class RuleElement<TSchema extends RuleElementSchema = RuleElementSchema> extends foundry.abstract.DataModel<ItemPF2e<ActorPF2e>, TSchema> {
     ...
     */
    resolveValue(value: unknown, defaultValue?: RuleValue, { evaluate, resolvables, warn }?: ResolveValueParams): number | string | boolean | object | null;
}
