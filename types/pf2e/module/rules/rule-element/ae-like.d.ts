...
declare class AELikeRuleElement<TSchema extends AELikeSchema> extends RuleElement<TSchema> {
    ...
    static validateJoint(data: fields.SourceFromSchema<AELikeSchema>): void;
    ...
    static getNewValue<TCurrent>(mode: AELikeChangeMode, current: TCurrent, change: TCurrent extends (infer TValue)[] ? TValue : TCurrent, merge?: boolean): (TCurrent extends (infer TValue)[] ? TValue : TCurrent) | validation.DataModelValidationFailure;
}
