...
import { DataUnionField, PredicateField, StrictArrayField } from "@system/schema-data-fields.js";
...
import { ItemAlteration } from "./item-alteration/alteration.js";
...
type AuraSchema = RuleElementSchema & {
    ...
    effects: StrictArrayField<fields.SchemaField<AuraEffectSchema>, fields.SourceFromSchema<AuraEffectSchema>[], fields.ModelPropsFromSchema<AuraEffectSchema>[], true, false, true>;
    /**
     ...
     */
    appearance: fields.SchemaField<AuraAppearanceSchema, fields.SourceFromSchema<AuraAppearanceSchema>, fields.ModelPropsFromSchema<AuraAppearanceSchema>, true, false, true>;
    /**
...
type AuraAppearanceSchema = {
    ...
    texture: fields.SchemaField<AuraTextureSchema, fields.SourceFromSchema<AuraTextureSchema>, fields.ModelPropsFromSchema<AuraTextureSchema>, false, true, true>;
};
