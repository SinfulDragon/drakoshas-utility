...
import type { DataUnionField, PredicateField, StrictArrayField, StrictBooleanField, StrictNumberField, StrictObjectField, StrictStringField } from "@system/schema-data-fields.js";
import type { RuleElementSchema, RuleElementSource } from "../data.js";
...
type ChoiceSetSchema = RuleElementSchema & {
    ...
    selection: DataUnionField<StrictStringField<string, string, true, false, false> | StrictNumberField<number, number, true, false, false> | StrictBooleanField<true, false, false> | StrictObjectField<object, object, true, false, false>, false, true, false>;
    ...
    allowedDrops: fields.SchemaField<AllowedDropsSchema, fields.SourceFromSchema<AllowedDropsSchema>, fields.ModelPropsFromSchema<AllowedDropsSchema>, false, true, false>;
