...
import { DataUnionField, PredicateField, StrictArrayField, StrictBooleanField } from "@system/schema-data-fields.js";
import type { AELikeDataPrepPhase } from "../ae-like.js";
import type { ResolvableValueField, RuleElementSchema } from "../data.js";
import type { RollOptionRuleElement } from "./rule-element.js";
...
type RollOptionSchema = RuleElementSchema & {
    ...
    suboptions: DataUnionField<fields.SchemaField<SuboptionConfigSchema, fields.SourceFromSchema<SuboptionConfigSchema>, fields.ModelPropsFromSchema<SuboptionConfigSchema>, false, false> | StrictArrayField<SuboptionField>, false, false, true>;
    /**
