 ...
 */
declare class TempHPRuleElement extends RuleElement<TempHPRuleSchema> {
...
type TempHPRuleSchema = RuleElementSchema & {
    ...
    events: fields.SchemaField<TempHPEventsSchema, fields.SourceFromSchema<TempHPEventsSchema>, fields.ModelPropsFromSchema<TempHPEventsSchema>, true, false, true>;
};
