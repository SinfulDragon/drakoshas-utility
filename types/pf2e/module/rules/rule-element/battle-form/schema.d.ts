...
import type { RecordField } from "@system/schema-data-fields.js";
...
import type { BattleFormSkills, BattleFormSpeeds, BattleFormStrike } from "./types.js";
...
type BattleFormRuleOverrideSchema = {
    ...
    armorClass: fields.SchemaField<OverrideACSchema, fields.SourceFromSchema<OverrideACSchema>, fields.ModelPropsFromSchema<OverrideACSchema>, false, false, true>;
