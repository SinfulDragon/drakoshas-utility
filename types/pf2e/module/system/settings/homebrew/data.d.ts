import type { Language } from "@actor/creature/index.js";
...
import { BaseArmorType } from "@item/armor/types.js";
import type { BaseWeaponType } from "@item/weapon/types.js";
import type { MenuTemplateData } from "../menu.js";
declare const HOMEBREW_ELEMENT_KEYS: readonly ["languages", "armorGroups", "baseArmors", "classTraits", "weaponCategories", "weaponGroups", "baseWeapons", "creatureTraits", "featTraits", "spellTraits", "weaponTraits", "shieldTraits", "equipmentTraits"];
