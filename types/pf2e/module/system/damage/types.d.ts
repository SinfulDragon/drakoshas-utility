import type { DamageDicePF2e, Modifier } from "@actor/modifiers.js";
import type { RollOrigin, RollTarget } from "@actor/roll-context/types.js";
import type { ImmunityType, ResistanceType } from "@actor/types.js";
import type { ZeroToTwo } from "@module/data.js";
import type { DegreeOfSuccessString } from "@system/degree-of-success.js";
import type { BaseRollContext } from "@system/rolls.js";
import type { DamageRoll } from "./roll.js";
import type { DAMAGE_CATEGORIES_UNIQUE, DAMAGE_DICE_FACES, DAMAGE_DIE_SIZES, DAMAGE_TYPES } from "./values.js";
