...
import { DamageCategory, DamageType } from "./types.js";
...
declare const MATERIAL_DAMAGE_EFFECTS: Set<"adamantine" | "cold-iron" | "duskwood" | "dawnsilver" | "orichalcum" | "silver" | "sisterstone-dusk" | "sisterstone-scarlet" | "warpglass">;
declare const DAMAGE_CATEGORIES: Set<"adamantine" | "cold-iron" | "duskwood" | "dawnsilver" | "orichalcum" | "silver" | "sisterstone-dusk" | "sisterstone-scarlet" | "warpglass" | "energy" | "physical" | "precision" | "splash" | "persistent">;
...
declare const DAMAGE_TYPES: Set<"poison" | "mental" | "sonic" | "acid" | "bleed" | "bludgeoning" | "cold" | "electricity" | "fire" | "force" | "piercing" | "slashing" | "spirit" | "vitality" | "void" | "untyped">;
...
export { BASE_DAMAGE_TYPES_TO_CATEGORIES, CRITICAL_INCLUSION, DAMAGE_CATEGORIES, DAMAGE_CATEGORIES_UNIQUE, DAMAGE_DICE_FACES, DAMAGE_DIE_SIZES, DAMAGE_TYPE_ICONS, DAMAGE_TYPES, ENERGY_DAMAGE_TYPES, MATERIAL_DAMAGE_EFFECTS, PERSISTENT_DAMAGE_IMAGES, PHYSICAL_DAMAGE_TYPES, };
