...
import { DamageDicePF2e, RawDamageDice } from "@actor/modifiers.js";
import type { ItemPF2e } from "@item";
import { WeaponDamage } from "@item/weapon/data.js";
import { DamageInstance, DamageRoll } from "./roll.js";
import { ArithmeticExpression, Grouping } from "./terms.js";
import type { BaseDamageData, DamageCategory, DamageDiceFaces, DamageDieSize, DamageType } from "./types.js";
import { ConvertedNPCDamage } from "./weapon.js";
...
declare const DamageCategorization: {
    ...
    readonly allCategories: () => Set<string | number | symbol | null>;
    /** Get a set of all of the base rule damage types. */
    readonly baseCategories: () => Set<string | number | symbol | null>;
...
declare function deepFindTerms(term: terms.RollTerm, { flavor }: {
    flavor: string;
}): terms.RollTerm[];
...
declare function processBaseDamage<TDamage extends ConvertedNPCDamage | WeaponDamage>(selector: string, unprocessed: TDamage, options: {
    actor: ActorPF2e;
    item: ItemPF2e<ActorPF2e>;
    domains: string[];
...
export { applyBaseDamageAlterations, applyDamageDiceOverrides, DamageCategorization, damageDiceIcon, damageDieSizeToFaces, deepFindTerms, extractBaseDamage, getDamageDiceOverrideLabel, getDamageDiceValueLabel, isSystemDamageTerm, isUnsimplifableArithmetic, looksLikeDamageRoll, nextDamageDieSize, processBaseDamage, renderComponentDamage, simplifyTerm, };
