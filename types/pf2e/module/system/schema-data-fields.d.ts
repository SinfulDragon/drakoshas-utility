...
import type { ArrayFieldOptions, DataFieldOptions, DataFieldValidationOptions, ObjectFieldOptions, StringFieldOptions } from "@common/data/_types.d.mts";
import type { CleanFieldOptions, MaybeSchemaProp, ModelPropFromDataField, SourceFromDataField, SourceFromSchema } from "@common/data/fields.d.mts";
...
declare class PrunedSchemaField<TDataSchema extends DataSchema = DataSchema, TSourceProp extends fields.SourceFromSchema<TDataSchema> = fields.SourceFromSchema<TDataSchema>, TModelProp extends NonNullable<JSONValue> = fields.ModelPropsFromSchema<TDataSchema>, TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends fields.SchemaField<TDataSchema, TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
    initialize(value: fields.MaybeSchemaProp<TSourceProp, TRequired, TNullable, THasInitial>, model?: foundry.abstract.DataModel, options?: Record<string, unknown>): MaybeSchemaProp<TModelProp, TRequired, TNullable, THasInitial>;
}
...
declare class StrictArrayField<TElementField extends fields.DataField, TSourceProp extends Partial<SourceFromDataField<TElementField>>[] = SourceFromDataField<TElementField>[], TModelProp extends object = ModelPropFromDataField<TElementField>[], TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends fields.ArrayField<TElementField, TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
    ...
    initialize(value: MaybeSchemaProp<TSourceProp, TRequired, TNullable, THasInitial>, model: DataModel, options: ArrayFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>): MaybeSchemaProp<TModelProp, TRequired, TNullable, THasInitial>;
}
/** An array field that will prune invalid elements without complaint */
declare class LaxArrayField<TElementField extends fields.DataField, TSourceProp extends SourceFromDataField<TElementField>[] = SourceFromDataField<TElementField>[], TModelProp extends object = ModelPropFromDataField<TElementField>[], TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends fields.ArrayField<TElementField, TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
...
declare class AnyChoiceField<TChoices extends JSONPrimitive, TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends fields.DataField<TChoices, TChoices, TRequired, TNullable, THasInitial> {
...
interface AnyChoiceField<TChoices extends JSONPrimitive, TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends fields.DataField<TChoices, TChoices, TRequired, TNullable, THasInitial> {
    choices: JSONPrimitive[];
    options: AnyChoiceFieldOptions<TChoices, TRequired, TNullable, THasInitial>;
}
interface AnyChoiceFieldOptions<TChoices extends JSONPrimitive, TRequired extends boolean, TNullable extends boolean, THasInitial extends boolean> extends DataFieldOptions<TChoices, TRequired, TNullable, THasInitial> {
    choices: JSONPrimitive[];
}
declare class DataUnionField<TField extends fields.DataField, TRequired extends boolean = boolean, TNullable extends boolean = boolean, THasInitial extends boolean = boolean> extends fields.DataField<TField extends fields.DataField<infer TSourceProp> ? TSourceProp : never, TField extends fields.DataField<infer _TSourceProp, infer TModelProp> ? TModelProp : never, TRequired, TNullable, THasInitial> {
    fields: TField[];
    constructor(fields: TField[], options: DataFieldOptions<TField extends fields.DataField<infer TSourceProp> ? TSourceProp : never, TRequired, TNullable, THasInitial>);
    protected _cast(value?: unknown): unknown;
    /**
...
type MaybeUnionSchemaProp<TField extends fields.DataField, TRequired extends boolean, TNullable extends boolean, THasInitial extends boolean> = MaybeSchemaProp<TField extends fields.DataField<infer _TSourceProp, infer TModelProp, boolean, boolean, boolean> ? TModelProp : never, TRequired, TNullable, THasInitial>;
...
declare class RecordField<TKeyField extends fields.StringField<string, string, true, false, false> | fields.NumberField<number, number, true, false, false>, TValueField extends fields.DataField, TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true, TDense extends boolean = false> extends fields.ObjectField<RecordFieldSourceProp<TKeyField, TValueField, TDense>, RecordFieldModelProp<TKeyField, TValueField, TDense>, TRequired, TNullable, THasInitial> {
    ...
    initialize(values: object | null | undefined, model: foundry.abstract.DataModel, options?: ObjectFieldOptions<RecordFieldSourceProp<TKeyField, TValueField>, TRequired, TNullable, THasInitial>): MaybeSchemaProp<RecordFieldModelProp<TKeyField, TValueField, TDense>, TRequired, TNullable, THasInitial>;
}
...
export { AnyChoiceField, DataUnionField, LaxArrayField, LaxSchemaField, NullableBooleanField, NullField, PredicateField, PrunedSchemaField, RecordField, SlugField, StrictArrayField, StrictBooleanField, StrictNumberField, StrictObjectField, StrictSchemaField, StrictStringField, };
