...
export default function ClientPackageMixin<TBase extends ConstructorOf<BasePackage>>(BasePackage: TBase): {
     ...
     *                                                        default.
     */
    getVersionBadge(availability: number, data: Partial<PackageManifestData>, options?: {
     ...
     * @protected
     */
    _formatBadDependenciesTooltip(availability: number, data: Partial<PackageManifestData>, deps: Iterable<RelatedPackage>, options?: {
        modules?: Collection<string, Module>;
        systems?: Collection<string, System>;
    }): string;
    /**
     ...
     * @protected
     */
    _formatIncompatibleSystemsTooltip(data: Partial<PackageManifestData>, relationships: Iterable<RelatedPackage>, options?: {
        systems?: Collection<string, System>;
    }): string;
    /**
     ...
     */
    fromRemoteManifest(manifest: string, options?: {
        strict?: boolean;
    }): Promise<{
        /**
         * Is this package marked as a favorite?
